...
def show_about(window, on_back): # the about screen! whoa!
    ...
    ctk.CTkLabel(frame, text="About Wakfudle", font=("Arial", 28, "bold")).pack(pady=20)
    ...
    about_text = (
        ...
        "Keep in mind Wakfudle uses official monster and item names\n"
        "for the answers. Make sure your answer is exactly the same as\n"
        "the names shown in-game!\n\n"
        "DISCLAIMER:\n"
